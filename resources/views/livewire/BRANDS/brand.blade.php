                ...
                <tbody>
                    ...
                    <tr class="border-b odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <button wire:navigate href="/brand/{{$allbrand->id}}/edit-brand"class="btn btn-secondary btn-sm">edit</button>
                            <button @click="$dispatch('edit-mode',{id:{{$allbrand->id}}})" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">Edit</button>
