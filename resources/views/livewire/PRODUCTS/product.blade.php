...
@endif
    ...
    <div>
        <div >
            <button data-modal-target="authentication-modal-Product" data-modal-toggle="authentication-modal-Product" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                Create Product
            </button>
        </div>
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr class="odd:bg-white even:bg-gray-50 dark:odd:bg-gray-900 dark:even:bg-gray-800">
                                <td class="px-3 py-4 font-medium text-center dark:text-white">
                                    <span class="inline-flex items-center justify-center text-sm font-medium text-gray-900 dark:text-white whitespace-nowrap">#{{ $product->id }}</span>
                                </span>
                                    </td>
                                ...
                                <td wire:ignore class="px-6 py-4 text-center">
                                    ...
                                    <!-- Trigger Edit Modal -->
                                    <button @click="$dispatch('edit-mode', { id: {{ $product->id }} })" data-modal-target="authentication-modal-Product" data-modal-toggle="authentication-modal-Product" class="font-medium text-green-600 text-[0.925rem] dark:text-green-500 hover:underline">Edit</button>
                                    <!-- Delete Button in Parent Blade File -->
                                    <button data-modal-target="popup-modal-{{ $product->id }}" data-modal-toggle="popup-modal-{{ $product->id }}" class="font-medium text-red-600 dark:text-red-500 hover:underline">
                                        Delete
                                        </button>
                                        <livewire:deleteproduct :product_id="$product->id" />
                                </td>
